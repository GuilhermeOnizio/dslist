# Intensivão Java DSList - Projeto de Lista de Jogos

Bem-vindo ao repositório do projeto DSList! Este projeto foi desenvolvido para organizar e exibir uma lista de jogos, com foco em praticar conceitos de desenvolvimento back-end. Aqui, você encontrará uma aplicação que permite visualizar, filtrar e interagir com uma coleção de jogos.
